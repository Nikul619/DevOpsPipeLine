...
#                                   WARNING: Attribute must be deleted then added to change type so may cause loss of data
   ...
   set bCommandFile "TRUE"  ;# TRUE or FALSE - extract/import of code of command in a file if set to TRUE, else code of command will be in Spinner file.
   ...
   set bUnifiedTyping "FALSE"       ;#TRUE or FALSE - Do not import Type, Interface, Relationship governed by Unified Typing rule/ Import Type, Interface, Relationship governed by Unified Typing rule
   set sUnifiedTypingExceptionalType "" ;#Type are delimited by pipe(|),Import Type irrespective of it is governed by Unified Typing rule
   ...
   set sUnifiedTypingExceptionalRelationship "Vaulted Objects" ;#Relationship are delimited by pipe(|),Import Relationship irrespective of it is governed by Unified Typing rule
   set sGlobalConfigType ""  
   set bJavaImport "FALSE"      ;# TRUE or FALSE - import files using java (high performance / fast import), if FALSE then tcl logic
   set sTransactionMode "RollbackEverything"      ;# RollbackEverything or RollbackSchemaType or RollbackCurrent use only one of this transaction mode for commiting data into database default RollbackEverything
#  ****************************************************************************
